...
function Question(formData, questionData, questionOptions, gridQuestionOptions){
    ...
    this.label = function(){
        ...
        //It may have a small description too
        if(this.question.text_exists==1){
            if(this.question.description){
                code += '<div class="question_attributes"><label for="question_' + this.question.id + '" class="question_title"><span id="question_number"></span> ' + this.question.text + '</label>';
                code += '<label for="question_' + this.question.id + '" class="question_description">' + this.question.description + '</label></div>';
            }else{
        ...
        if(this.question.image==1){
            code += '<div class="image_attributes"><img src="' + this.question.image_path + '" alt="image for ' + this.question.id + '" /></div>';
        }
    ...
    this.checkBoxMultiple = function(){
        ...
        for(i=0;i<this.options.length;i++){
            if(this.options[i].image==1 && this.options[i].text_exists==1){
                ...
                //code += '<div id="checkbox_label"><label for="question_' + this.question.id + '_' + this.options[i].id_option + '">' + this.options[i].text + '</label></div><div id="checkbox_image"><img src="' + rootPath + "/" + this.options[i].image_path + '" alt="image option ' + (i+1) + '" style="float: left"/></div>';
                code += '<div id="checkbox_image"><img src="' + rootPath + "/" + this.options[i].image_path + '" alt="image option ' + (i+1) + '" style="float: left"/></div><div id="checkbox_label"><label for="question_' + this.question.id + '_' + this.options[i].id_option + '">' + this.options[i].text + '</label></div>';
    ...
    this.paintGridQuestion = function(){
        var widthAux = parseInt(jQuery('#' + this.form.place).width()/(this.gridOptions.columns.length + 1));
        var cellWidth = widthAux - widthAux%100 + 100;
        var restCellWidth = parseInt((jQuery('#' + this.form.place).width() - cellWidth)/(this.gridOptions.columns.length));
        var code = "<div id='div_question_" + this.question.id + "' class='question'>";
        ...
        //and including the validations
        var questionClass = "active choices";
        if(this.question.mandatory==1 && this.question.subtype.toLowerCase()!="textfields_unique" && this.question.subtype.toLowerCase()!="textfields_multiple"){
        //if(this.question.mandatory==1){
            questionClass += " required";
        }else if(this.question.subtype.toLowerCase()!="textfields_unique" || this.question.subtype.toLowerCase()!="textfields_multiple"){
            if(this.question.subtype.toLowerCase()=="textfields_unique"){
                questionClass += " required_group_unique";
            }else if(this.question.subtype.toLowerCase()=="textfields_multiple"){
                questionClass += " required_group_multiple";
            }
        }
        if(this.question.validation){
            questionClass += " " + this.question.validation;
        ...
        //first row is the columns, and first column are the options. Inside the rest of the cells lets draw the radioButtons
        for(var i=0;i<this.gridOptions.rows.length;i++){
            ...
            for(var j=0;j<this.gridOptions.columns.length;j++){
                //paint the option
                ...
                }else if(this.question.subtype.toLowerCase()=="checkboxes"){
                    //checkBoxes grid
                ...
                }else if(this.question.subtype.toLowerCase()=="textfields_unique"){
                    //textfields grid
                    //code += "<td align='center' valign='center' style='width: " + restCellWidth + "px; height: 60px;'><div class='textfield'><input type='text' class='" + questionClass + " " + " grid_textfield_unique' name='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' id='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "'/></div><div class='label_error'><label for='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' class='error' generated='true'></label></div>";
                    code += "<td align='center' valign='center' style='width: " + restCellWidth + "px; height: 60px;'><div class='textfield'><input type='text' class='" + questionClass + " " + " grid_textfield_unique' name='grid_" + this.question.id + "_row_" + this.gridOptions.rows[i].id + "' id='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "'/></div><div class='label_error'><label for='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' class='error' generated='true'></label></div>";
                    if((j+1)!=this.gridOptions.columns.length){
                        code += "</td>";
                    }
                }else if(this.question.subtype.toLowerCase()=="textfields_multiple"){
                    //textfields grid
                    //name equal to id (long)
                    //code += "<td align='center' valign='center' style='width: " + restCellWidth + "px; height: 60px;'><div class='textfield'><input type='text' class='" + questionClass + " grid_textfield_multiple' name='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' id='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' /></div><div class='label_error'><label for='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' class='error' generated='true'></label></div>";
                    
                    //name short, every row cells have the same name attr
                    //code += "<td align='center' valign='center' style='width: " + restCellWidth + "px; height: 60px;'><div class='textfield'><input type='text' class='" + questionClass + " grid_textfield_multiple' name='grid_" + this.question.id + "_row_" + this.gridOptions.rows[i].id + "' id='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' /></div><div class='label_error'><label for='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' class='error' generated='true'></label></div>";
                    
                    //name short and no div for label.error
                    code += "<td align='center' valign='center' style='width: " + restCellWidth + "px; height: 60px;'><div class='textfield'><input type='text' class='" + questionClass + " grid_textfield_multiple' name='grid_" + this.question.id + "_row_" + this.gridOptions.rows[i].id + "' id='grid_" + this.question.id + "_" + this.gridOptions.rows[i].id + "_" + this.gridOptions.columns[j].id + "' /></div>";
            ...
            /*if(this.question.subtype.toLowerCase()!="textfields_multiple" && this.question.subtype.toLowerCase()!="textfields_unique"){
